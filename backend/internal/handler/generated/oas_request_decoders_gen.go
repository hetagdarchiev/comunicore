...
func (s *Server) decodeAnalyticsVisitBatchSubmitRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request AnalyticsVisitBatchRequest
		if err := func() error {
...
func (s *Server) decodeMediaUploadRequest(r *http.Request) (
	...
	case ct == "multipart/form-data":
		...
		var request MediaUploadRequestMultipart
		{
			if err := func() error {
				...
				request.Content = ht.MultipartFile{
					Name:   fh.Filename,
					File:   f,
					Size:   fh.Size,
					Header: fh.Header,
...
func (s *Server) decodeUserUpdateRequest(r *http.Request) (
