 ...
 * Create a new user
 */
export const userCreateMutation = (options?: Partial<Options<UserCreateData>>): UseMutationOptions<UserCreateResponse2, UserCreateError, Options<UserCreateData>> => {
    const mutationOptions: UseMutationOptions<UserCreateResponse2, UserCreateError, Options<UserCreateData>> = {
 ...
 */
export const userMeOptions = (options?: Options<UserMeData>) => queryOptions<UserMeResponse, UserMeError, UserMeResponse, ReturnType<typeof userMeQueryKey>>({
 ...
 * Delete a user
 */
export const userDeleteMutation = (options?: Partial<Options<UserDeleteData>>): UseMutationOptions<UserDeleteResponse, DefaultError, Options<UserDeleteData>> => {
    const mutationOptions: UseMutationOptions<UserDeleteResponse, DefaultError, Options<UserDeleteData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const userUpdateMutation = (options?: Partial<Options<UserUpdateData>>): UseMutationOptions<UserUpdateResponse, DefaultError, Options<UserUpdateData>> => {
...
=======
export const mediaUploadMutation = (options?: Partial<Options<MediaUploadData>>): UseMutationOptions<MediaUploadResponse2, MediaUploadError, Options<MediaUploadData>> => {
    const mutationOptions: UseMutationOptions<MediaUploadResponse2, MediaUploadError, Options<MediaUploadData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await mediaUpload({
                ...options,
                ...fnOptions,
...
>>>>>>> 1a3e81a08db77b823a2125691dd10b0c35cf1405
